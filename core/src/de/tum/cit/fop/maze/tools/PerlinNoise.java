...
/**
 * Utility class providing a 2D Perlin noise implementation.
 *
 * <p>Perlin noise is a smooth, continuous pseudo-random function commonly
 * used for procedural generation, such as terrain, textures, or visual
 * effects.
 *
 * <p>The generated noise values are deterministic and repeatable for the
 * same input coordinates.
 *
 * <p>This implementation produces values in the range {@code [0.0, 1.0]}.
 */
public class PerlinNoise {
    ...
    static {
        int[] permutation = {
                ...
                255,82,85,212,207,206,59,227,47,
                16,58,17,182,189,28,42,223,183,
                170,213,119,248,152,2,44,154,163,
                ...
                181,199,106,157,184,84,204,176,
                115,121,50,45,127,4,150,254,
                138,236,205,93,222,114,67,29,24,
                72,243,141,128,195,78,66,215,61,
                156,180
        };
        for (int i = 0; i < 256; i++) {
    ...
    /**
     * Computes a 2D Perlin noise value for the given coordinates.
     *
     * <p>The returned value is smoothly interpolated and lies in the range
     * {@code [0.0, 1.0]}.
     *
     * @param x the x-coordinate in noise space
     * @param y the y-coordinate in noise space
     * @return a Perlin noise value between 0.0 and 1.0
     */
